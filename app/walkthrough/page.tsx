...
const SECTIONS: Section[] = [
  { id: "temps", title: "Temps", max: 18, items: [
  ...
  { id: "sanitation", title: "Sanitation", max: 18, items: [
  ...
  { id: "uniform", title: "Uniform & Appearance", max: 8, items: [
  ...
  { id: "great_remake", title: "Great/Remake Controls", max: 16, items: [
  ...
  { id: "prp", title: "PRP (Pre-Req Programs)", max: 15, items: [
...
export default function WalkthroughPage() {
  ...
  const walkthroughTotal = sectionScores.reduce((sum, s) => sum + s.capped, 0);
  const service = scoreService(adt, extLate, sbr);
  const predicted = walkthroughTotal + service.total;
  ...
  return (
    <div style={{ maxWidth: 820, margin: "0 auto" }}>
      ...
      <p style={{ marginTop: 0 }}>Tick what’s in place before open; enter service metrics; get a predicted OER score. Click Save to store it.</p>
      ...
      <div style={{ border: "1px solid #eee", borderRadius: 12, padding: 16, margin: "16px 0" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
          <div>
            ...
            <input type="number" step="0.1" placeholder="e.g. 24.0" value={adt}
          ...
          <div>
            ...
            <input type="number" step="0.1" placeholder="e.g. 1.2" value={extLate}
          ...
          <div>
            ...
            <input type="number" step="0.1" placeholder="e.g. 78" value={sbr}
